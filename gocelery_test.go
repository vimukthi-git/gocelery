...
func getAMQPClient() (*CeleryClient, error) {
	...
	return NewCeleryClient(amqpBroker, amqpBackend, 4, 0)
}
...
func getRedisClient() (*CeleryClient, error) {
	...
	return NewCeleryClient(redisBroker, redisBackend, 1, 0)
}
...
func getInMemoryClient(numWorkers int) (*CeleryClient, error) {
	...
	return NewCeleryClient(inMemoryBroker, inMemoryBackend, numWorkers, 0)
}
